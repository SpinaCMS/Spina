...
Spina::Engine.routes.draw do
  ...
  unless Spina.config.disable_frontend_routes
    ...
    # Pages
    get "#{prefix}/:locale/*id" => "pages#show", constraints: { locale: /#{Spina.config.locales.join("|")}/ }
    get "#{prefix}/:locale/" => "pages#homepage", constraints: { locale: /#{Spina.config.locales.join("|")}/ }
    get "#{prefix}/*id" => "pages#show", as: "page", controller: "pages", constraints: lambda { |request|
